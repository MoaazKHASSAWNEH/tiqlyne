...
class NativePlaybackTestDriver implements MotionDriver<string> {
  ...
  readonly controller: MotionPlaybackController = {
    ...
    seekProgress: async (): Promise<MotionPlaybackResult> => ({
      status: 'running',
    ...
    playForward: async (): Promise<MotionPlaybackResult> => ({
      status: 'running',
      reason: 'native-controller-play-forward'
    }),
    playBackward: async (): Promise<MotionPlaybackResult> => ({
      status: 'running',
